...
import dragon from "../imgs/clickables/dragon.gif";
import corridorFacing from "../imgs/CorridorFacing.png";
import doorway from "../imgs/clickables/NormalDoorway.png";

import thanks from "../imgs/thanks.png";
import ryan from "../imgs/ryan.png";
import cody from "../imgs/cody.png";
            ...
            action: {
              ...
              second: [
                ...
                },
                {
                  ...
                  className: "talk__elements__button",
                  value:
                    "You settle in for the show.  Your mind slips into a thoughtless hunger and you can't stop eating.",
                  transition: "battle",
                },
                {
                  id: 10,
  ...
  options: [
    {
      ...
      type: "examine",
      text: "Examine?",
      topBar: "You examine the elf.  She doesn't look happy that her tv watching has been interrupted.",
      link: null,
    },
    {
      visible: true,
...
export let dragonRoom = {
  name: "dragonRoom",
  topBar:
    "You enter the room. There is a door, blocked by a dragon. An iron collar, connected to a chain that is anchored to the wall, hangs around her neck. What do you do?",
  objects: [
    {
      id: 6,
      name: "dragonDoorway",
              ...
              first: [
                {
                  ...
                  className: "talk__elements__text",
                  value:
                    'Sniffling, clearing the tear from her eyes, she asks, "Can you free me from these chains?"  Her eyes are flaring in anticipation.',
                },
                {
                  type: "div",
                  className: "talk__elements__text",
                  value:
                    "\"I've been imprisoned here for...  I don't even know anymore...\"  When you look at the chains, you notice a keyhole shaped like the Formula of Universal Truth.",
                },
                {
                  id: 2,
                  type: "button",
                  className: "talk__elements__button",
                  value: "Use the sword to open the lock, risking damage to it and losing any hope for your village.",
                  next: "second",
                  giveXP: 1,
                },
                {
                  ...
                  className: "talk__elements__button",
                  value:
                    "Squeeze past the dragon and through the door. You're village needs this sword and you aren't risking it for some dragon.",
                  next: "second",
                },
              ...
              second: [
                {
                  ...
                  type: "div",
                  className: "talk__elements__text",
                  value: "You put the sword into the lock.  The iron collar falls off the dragon’s neck.",
                  remove: [{ type: "option", name: "battle" }, { type: "option", name: "examine" }],
                  add: "doorway",
                },
                {
                  ...
                  className: "talk__elements__text",
                  value:
                    "Thank you,” she says, as she pushes her oversized body through the doorway.  Cautiously, you follow.",
                  remove: [{ type: "option", name: "battle" }, { type: "option", name: "examine" }],
                  add: "doorway",
                },
                {
                ...
                },
                {
                  ...
                  className: "talk__elements__button",
                  value:
                    "You try to sneak past the dragon.  Her sadness was a trick as she breaks her chains and attacks.",
                  transition: "battle",
                },
                {
                  id: 10,
              ...
              third: [
                {
                  type: "div",
                  className: "talk__elements__text",
                  value: "Kant argues that selfishness can’t be universalized.",
                },
                {
                  type: "div",
                  className: "talk__elements__text",
                  value:
                    "Basically, everyone needs help at some point in their lives.  To universalize selfishness would be to will that people don’t help you when you need it. ",
                },
                {
                  type: "div",
                  className: "talk__elements__text",
                  value:
                    "No rational person would do that. Thus, we have an imperfect duty to other not to be selfish.  Don't be selfish --- ever.",
                },
                {
                  type: "div",
                  className: "talk__elements__text",
                  value:
                    "further Consideration?  Do you think we should help other because we want others to help us? ",
                },
                {
                  type: "a",
                  className: "talk__elements__link",
  ...
  options: [
    {
      ...
      type: "examine",
      text: "Examine?",
      topBar: "You examine the dragon. Her eyes burn with curiosity steeped in sadness.",
      link: null,
    },
    {
      visible: true,
      ...
      topBar: null,
      link: null,
      opponent: opponents.dragon,
    },
  ],
  bonusOpponent: opponents.dragon,
};

export let threeDoorsRoomSecond = {
  name: "threeDoorsRoomSecond",
  topBar: "You enter the room. The room looks slightly different than the last time you were here. What do you do?",
  objects: [
    {
      id: 3,
      name: "threeDoors",
  ...
  options: [
    {
      ...
      text: "Examine?",
      topBar:
        "The door to the left closes behind you as you enter.  You examine the room.  The door to the right is no longer open.  The center door opens and you can barely make out a spiral staircase in the darkness.",
      link: {
        show: false,
        page: 24,
      },
...
export let end = {
  name: "end",
  topBar: "The second half of the adventure is not readily available, check back for updates!  This is only the first iteration.  If you notice bugs, feel free to contact me knoxvillain@live.com.  I'm aware the UI isn't as uniform as it should be :)",
  objects: [
    {
      id: 1,
      name: "thanks",
